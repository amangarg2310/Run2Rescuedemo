...
function Journey() {
  const items = [
    { name: "Luna", before: IMG.before1, after: IMG.after1, story: "Rescued from a meat farm in South Korea. Luna now lives with her loving family in California." },
    { name: "Bao", before: IMG.before2, after: IMG.after2, story: "Found injured and alone. Bao made a full recovery and was adopted within weeks." },
    { name: "Mochi", before: IMG.before3, after: IMG.after3, story: "Once too afraid to be touched. Mochi now loves adventures with her new family." },
  ];
  return (
    <section className="section-light" style={{ padding: "64px 0 80px", position: "relative" }}>
      ...
      <div className="wrap">
        ...
        <div className="ways-grid journey-grid" style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 20 }}>
          {items.map(it => (
